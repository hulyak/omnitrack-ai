...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'GET STARTED' button to reach the login or onboarding flow.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/main/div/div[2]/div[2]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Navigate to /login to reach the login form (explicit navigation per test steps).
        await page.goto("http://localhost:3000/login")
        
        # -> Fill the Email and Password fields with demo@omnitrack.ai and demo, then submit the Sign In button and wait for the dashboard to load.
        frame = context.pages[-1]
        # Input text
