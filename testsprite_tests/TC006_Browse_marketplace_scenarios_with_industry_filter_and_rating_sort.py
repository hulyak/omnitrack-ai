...
async def run_test():
    ...
    try:
        ...
        # -> Click 'Try Demo Mode' to enter the app as demo user and reach the marketplace UI.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/div/div[3]/button').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'Marketplace' link in the top navigation to open the marketplace UI.
        frame = context.pages[-1]
        # Click element
        elem = frame.locator('xpath=/html/body/div/header/div/div[2]/div/a[7]').nth(0)
        await asyncio.sleep(3); await elem.click()
        
        # -> Click the 'electronics' industry filter button (element index 1526) to filter scenarios by electronics.
        frame = context.pages[-1]
        # Click element
